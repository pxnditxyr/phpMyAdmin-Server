...
<html lang="en">
  ...
  <a class="navbar-brand" ><img src="logo.png" height="50" width="60" alt=""></a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="info.php">phpinfo<span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
...
<div class="card">
  ...
  <h2 class="name">phpMyAdmin</h2>
  <div class="title">Servidor de bases de datos</div>
  <div class="actions">
    <div class="follow-info">
      <h2><a href="#"><span>3M</span><small>Followers</small></a></h2>
  ...
  <div class="desc">phpMyAdmin es una herramienta escrita en PHP con la intención de manejar la administración de MySQL a través de páginas web, utilizando un navegador web.</div>
</div>




<h1><p class="text-info text-center">PXNDXS</p></h1>
</div>

    <!-- Optional JavaScript -->
    <!-- jQuery first, then Popper.js, then Bootstrap JS -->
    <script src="boot/js/jquery-3.5.1.slim.min.js"></script>
